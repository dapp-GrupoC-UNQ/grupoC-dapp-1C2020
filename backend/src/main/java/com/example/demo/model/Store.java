...
public class Store {
    ...
    List<StoreSchedule> storeTimeSchedule;
    List<Discount> discountList = new ArrayList<>();
    List<Merchandise> merchandiseList = new ArrayList<>();

    public Store(String name, String category, String address, Integer distanceInKm,
                 List<String> paymentMethods, List<StoreSchedule> timeSchedule, LocalDate openingDateTime) {
         storeName = name;
    ...
    public Boolean isOpenAt(DayOfWeek dia, LocalTime hora) {
        return   storeTimeSchedule.stream().anyMatch(horario -> horario.isAvailableOnTime(dia, hora));
    }
